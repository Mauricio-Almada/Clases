...
Para las casas registra además la cantidad de ambientes, y la superficie construída; para los
...
Diseñar las clases que se consideren convenientes. Utilizar si corresponde herencia, composición
o ambas.
*/
#include "Fecha.h"
#include "Direccion.h"
